...
import { X, Key, Sparkles, CheckCircle2, ShieldAlert, ExternalLink, Cpu } from "lucide-react";
        ...
        <form onSubmit={handleSave} className="flex flex-col gap-4">
          <div className="flex flex-col gap-1.5">
            ...
            <input
              ...
              className="w-full bg-zinc-900/80 border border-zinc-800 focus:border-emerald-500 rounded-xl px-3.5 py-2.5 text-xs text-zinc-100 placeholder:text-zinc-600 outline-none font-mono"
            />
